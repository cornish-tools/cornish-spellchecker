...
The spell-checker is also not complete, there is still coverage to improve (see the scores below). Some of the known gaps in functionality are listed [under issues](https://github.com/cornish-tools/cornish-spellchecker/issues). Also, if you encounter an issue, please help us by [raising an issue here](https://github.com/cornish-tools/cornish-spellchecker/issues).
